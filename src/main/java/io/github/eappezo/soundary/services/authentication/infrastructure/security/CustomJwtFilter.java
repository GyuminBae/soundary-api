...
import io.github.eappezo.soundary.services.authentication.infrastructure.JwtAuthenticationExtractor;
...
public class CustomJwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        APIAuthentication authentication = jwtAuthenticationExtractor.extractAuthenticationFrom(token);
        try {
