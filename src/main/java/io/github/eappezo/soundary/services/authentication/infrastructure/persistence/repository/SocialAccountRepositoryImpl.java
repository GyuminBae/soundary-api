...
import io.github.eappezo.soundary.services.authentication.application.SocialAccountRepository;
...
public class SocialAccountRepositoryImpl implements SocialAccountRepository {
    ...
    @Override
    public Optional<Identifier> findUserIdBySocialInfo(SocialPlatform platform, String socialId) {
